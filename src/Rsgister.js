...
function Rsgister() {
  ...
  const history = useHistory();
    ...
    function adduser(){
        ...
        swal( "Registration" ,  "Registration is completed !" ,  "success" ); 
    ...
    return (
        ...
        <div className="register">   
         ...
         <h2 style={{fontSize:"70px",textAlign:"center",marginBottom:"10px",color:"white"
        ...
        <input type="submit" className="btn btn-primary" value="Sign Up" onClick={adduser}/>
