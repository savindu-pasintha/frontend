  ...
  return (
    <div className="profile container">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <input
              type="number"
              className="p_input"
              placeholder={"+94 777 111 666"/*user_details.cust_phone*/}
              disabled={true}
            />
          </td>
        </tr>
        ...
        <tr>
          <td>
            <AiFillCreditCard /> Password
          </td>
          <td>
            <input
              type="text"
              className="p_input"
              placeholder={"password"/*user_details.cust_password*/}
              disabled={true}
            />
          </td>
        </tr>
      ...
      <button className="button">
        <Link to="/edituser" style={{ textDecration: "none", color: "white" }}>
          {" "}
          <MdEdit /> Edit{" "}
        </Link>
      </button>
