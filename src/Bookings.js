  ...
  var renderTable = () => {
    if (false) {
      return booking_details.map((item) => {
        var { r_id, room_id, booking_date, start_date, end_date, amount } =
          item;
        return (
          <div className="table-row">
            ...
            <div className="table-data">
              {!(formatDate(start_date) < formatDate(new Date())) ? (
                <button
                  style={{
      ...
      return (
        <div className="table-row">
          ...
          <div className="table-data">2021-11-05</div>
          <div className="table-data">2021-11-10</div>
          <div className="table-data">2021-11-12</div>
          <div className="table-data">02</div>
          <div className="table-data">
            {!(formatDate(10) < formatDate(new Date())) ? (
              <button
                style={{
                  backgroundColor: "#C52184",
                  color: "white",
